...
//        blog.setBlogId(blogId);
    ...
    public int addPraiseCount(int blogId, int userId) {
        System.out.println("QWEQWE"+blogId+"::::"+userId);
    ...
    @RequestMapping("/decreaseUnPraiseCount")
    public int decreaseUnPraiseCount(int blogId, int userId) {
        return blogService.decreaseUnPraiseCount(blogId, userId);
    }
    ...
    @RequestMapping("/getUnPraiseCount")
    public AjaxResult getUnPraiseCount(int blogId) {
        return toAjax(blogService.getUnPraiseCount(blogId));
    }
