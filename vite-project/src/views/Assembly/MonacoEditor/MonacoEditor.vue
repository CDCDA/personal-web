...
//       //创建编辑器
//       this.editor = window.monaco.editor.create(document.getElementById(this.id), this.cmOptions);
//       if (this.value) {
//         //初始化编辑器内容
...
//       //添加tlw方法提示
//       if (methodsList) {
//         this.current = window.monaco.languages.registerCompletionItemProvider('javascript', {
...
//             if (scripts[i] && scripts[i].innerHTML && scripts[i].innerHTML == innerHTML) {
